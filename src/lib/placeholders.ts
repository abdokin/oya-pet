...
const PLACEHOLDERS = {
  HEROS: [
    // primaryHero
    {
      heading: {value: 'OYAPET drying product essential for pet'},
      byline: {
        value: 'OYAPET drying product essential for pet',
      },
      cta: {value: 'Shop Now →'},
      handle: 'freestyle',
      spread: {
        reference: {
          ...
          alt: 'OYAPET drying product essential for pet',
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0635/8689/4055/files/1_bcfbb2b8-86a7-4aea-8bb4-c6b29eca6ba4.jpg?v=1666366355',
          },
      ...
      spreadSecondary: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0635/8689/4055/files/2_7fe6aa71-25bf-48da-84d5-7c7b9d9c34cb.jpg?v=1666366355',
          },
